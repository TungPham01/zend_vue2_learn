<template>
  <div class="wrapper_control">
    ...
    <button @click="rollDice" class="control btn-roll">
      <i class="ion-ios-loop"></i>Roll dice
    </button>
    <button @click="$emit('handleHold')" class="control btn-hold">
...
export default {
  ...
  methods: {
    newGame() {
      this.$emit("handleNewGame", true);
    },
    rollDice() {
      this.$emit("handleRollDice", true);
    },
  },
};
</script>
